//package com.david.springjwt.config;
//
...
//        return new ApiInfoBuilder().title("Spring-JWT").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("David").version("1.0").build();
//    }
//
//
//}
